...
strawweight_range = np.arange(0, 106, 1)
light_flyweight_range = np.arange(106, 110, 1)
...
super_welterweight_range = np.arange(148, 155, 1)
middleweight_range = np.arange(155, 161, 1)
super_middleweight_range = np.arange(161, 169, 1)
light_heavyweight_range = np.arange(169, 176, 1)
cruiserweight_range = np.arange(176, 201, 1)
heavyweight_range = np.arange(200, 1000, 1)
